...
for i=1:length(nSTOs)
   ...
   %Transmit signal
   x = []; % Initialize a block of OFDM signals|��ʼ��OFDM�ź�
   for m=1:Nsym % random bits generates |����OFDM����
